!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){var $=__webpack_require__(2);window.jQuery=$,window.$=$,__webpack_require__(1)},function(module,exports){function getLogs(logsurl){""==logsurl?$("#logspre").html("").append("No logs to display. Make sure you specify the log querystring param containing a valid log filename"):($.support.cors=!0,$.ajax({type:"GET",url:logsurl,contentType:"text/plain; charset=utf-8",headers:{Accept:"text/plain; charset=utf-8"},success:function(logs,status){"success"==status?$("#logspre").html("").append(logs):$("#logspre").html("").append("No logs to display. Make sure you specify the log querystring param containing a valid log filename")},statusCode:{404:function(){$("#logspre").html("").append("No logs to display. Make sure you specify the log querystring param containing a valid log filename")},500:function(){$("#logspre").html("").append("No logs to display. Make sure you specify the log querystring param containing a valid log filename")}},error:function(e){$("#logspre").html("").append("No logs to display. Make sure you specify the log querystring param containing a valid log filename")}}))}function getQueryStringParams(){var s2,i,quertStringParams=location.search.substring(1,location.search.length).split("&"),result={};for(i=0;i<quertStringParams.length;i+=1)s2=quertStringParams[i].split("="),result[decodeURIComponent(s2[0]).toLowerCase()]=decodeURIComponent(s2[1]);return result}$(document).ready(function(){var queryString=getQueryStringParams(),logFile=queryString.log;logFile&&logFile.length>0?(0==logFile.indexOf("/")&&(logFile=logFile.substring(1,logFile.length)),getLogs("http://ec2-34-209-37-87.us-west-2.compute.amazonaws.com:8080/charles-rest/api/logs/"+logFile),setInterval(function(){getLogs("http://ec2-34-209-37-87.us-west-2.compute.amazonaws.com:8080/charles-rest/api/logs/"+logFile)},1e4)):getLogs("")})},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
